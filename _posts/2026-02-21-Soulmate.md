...
- Since I had administrative privileges, I reset Ben’s password to a known value and authenticated as that user. This allowed me to upload a PHP reverse shell into the `WebProd` directory.
